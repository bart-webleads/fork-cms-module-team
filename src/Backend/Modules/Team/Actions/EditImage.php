...
class EditImage extends ActionEdit
{
    ...
    protected function loadData()
    {
        ...
        $this->record = BackendTeamImagesModel::get($this->id);
    }
        ...
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                foreach ($this->languages as $language) {
                    ...
                    $specific['url'] =  BackendTeamImagesModel::getURL(CommonUri::getUrl($specific['name']), $language['abbreviation'], $item['id']);
                ...
                BackendTeamImagesModel::updateContent($content, $item['id']);
