    ...
    protected function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                $item['sequence'] = BackendTeamCategoryModel::getMaximumSequence() + 1;
                $item['parent_id']  = $fields['parent_id']->getValue();
                $item['id'] = BackendTeamCategoryModel::insert($item);
                ...
                foreach($this->languages as $language)
                {
                    ...
                    $specific['url'] =  BackendTeamCategoryModel::getURL(CommonUri::getUrl($specific['name']), $language['abbreviation']);
                ...
                // insert it
               BackendTeamCategoryModel::insertContent($content);
