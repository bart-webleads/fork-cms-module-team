...
class EditCategory extends ActionEdit
{
    ...
    protected function loadData()
    {
        ...
        if ($this->id == null || !BackendTeamCategoryModel::exists($this->id)) {
            $this->redirect(
                Model::createURLForAction('Index') . '&error=non-existing'
            );
        }

        $this->record = BackendTeamCategoryModel::get($this->id);
    }
        ...
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                if ($item['parent_id'] == 0) {
                    ...
                    $category = BackendTeamCategoryModel::get($item['parent_id']);
                ...
                foreach ($this->languages as $language) {
                    ...
                    $specific['url'] =  BackendTeamCategoryModel::getURL(CommonUri::getUrl($specific['name']), $language['abbreviation'], $item['id']);
                ...
                BackendTeamCategoryModel::updateContent($content, $item['id']);
